<%@ Page Language="VB" MasterPageFile="~/MasterPageGreenLF.master" AutoEventWireup="false" CodeFile="Member_Registration.aspx.vb" Inherits="Member_Registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div valign="top" style="clip: rect(0px, auto, auto, auto);">
                <div id="pnlPersonalDetails" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid; background-color: #F0F0F0;">
                ...
                <div style="vertical-align: bottom;" class="divFormMng">
                    ...
                    <div style="text-align: left">
                        &nbsp;<asp:Button ID="btnSavePersonal" runat="server" Text="Save" CssClass="nextPrevButton" Visible="False" />&nbsp;<asp:Button ID="btnPerNext" runat="server" Text="Register" CssClass="button" />
                    ...
                    <div>
                        ...
                        <div id="pnlAddNextKin" runat="server" visible="false">
                            ...
                            <div style="align-items: center">
                                <asp:Button ID="btnSaveAddNextKin" runat="server" CssClass="button" Text="Save" />
                                &nbsp;
                                                        <asp:Button ID="btnCancelAddNextKin" runat="server" CssClass="button" Text="Cancel" />
                            </div>
                        </div>
                        <div>&nbsp;</div>
                    </div>
                ...
                <div id="pnlHuntingDetails" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;" visible="False">
                    ...
                    <div>
                        <div class="divFormMng">
                            ...
                            <div>
                                <asp:Button ID="btnAddFireArm" runat="server" CssClass="button" Text="Add Firearm" /></div>
                            <div id="pnlAddFireArm" runat="server" visible="false">
                                ...
                                <div>&nbsp;</div>
                                <div style="align-items: center">
                                    <asp:Button ID="btnAddFireArmUpdate" runat="server" CssClass="button" Text="Save" />
                                    &nbsp;
                                                        <asp:Button ID="btnAddFireArmCancel" runat="server" CssClass="button" Text="Cancel" />
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="divFormMng">
                            ...
                            <div>
                                <asp:Button ID="btnAddPermit" runat="server" CssClass="button" Text="Add Permit" /></div>
                            <div id="pnlPermits" runat="server" visible="false">
                                ...
                                <div>&nbsp;</div>
                                <div style="align-items: center">
                                    <asp:Button ID="btnAddPermitUpdate" runat="server" CssClass="button" Text="Save" />
                                    &nbsp;
                                                        <asp:Button ID="btnAddPermitCancel" runat="server" CssClass="button" Text="Cancel" />
                                </div>
                            </div>
                        ...
                        <div>
                            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" BorderStyle="None" EmptyDataText="No Fire Arms Registered" Font-Size="Small" GridLines="Horizontal" Width="60%">
                                <Columns>
                                    ...
                                    <asp:ButtonField ButtonType="Image" Text="Edit" CommandName="Edit" ImageUrl="~/Images/Icons/edit.png"></asp:ButtonField>
                ...
                <div id="pnlMembershipFee" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;" visible="False">
                    ...
                    <div style="align-items: flex-start">
                        <asp:Panel ID="Panel1" runat="server" BackColor="#F7F7F7" Width="60%">
                    ...
                    <div style="align-items: center">
                        ...
                        <div class="divFormMng">
                            <div>
                                <asp:Button ID="btnPayNow" runat="server" CssClass="button" Text="Pay Now" /></div>
                            <div>&nbsp;</div>
                        </div>
                        <div class="divFormMng">
                            <div>&nbsp;</div>
                        ...
                        <div class="divFormMng">
                            <div>
                                <asp:Button ID="btnPayLater" runat="server" CssClass="button" Text="Pay Later" />
                                <asp:Label ID="lblsubmitMsg" runat="server"></asp:Label>
                            </div>
                            <div>Limited functionailty</div>
                        </div>
                ...
                <div id="pnlUserDetails" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;" visible="False">
                    ...
                    <div>&nbsp;</div>
                    <div>
                        <asp:Button ID="btnCreateUser" runat="server" CssClass="button" Text="Create User Profile" /><asp:Label ID="lblUserMsg" runat="server"></asp:Label></div>
                    <div>&nbsp;</div>
                    <div style="text-align: right">
                ...
                <%--    <div class="divFormMng" style="border-width: thin; border-color: #FFFF00; vertical-align:top; border-top-style: solid; border-right-style: solid; border-left-style: inset;">
    ...
    <div>
        <asp:Label ID="lblId" runat="server" ForeColor="#494D4E" Text="8"></asp:Label></div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
