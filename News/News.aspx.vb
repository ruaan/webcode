...
Partial Class News_News
    ...
    Private Function PopulateNews() As String
        ...
        For sp = 0 To count
            ...
            htmlString &= "<a href='news_view.aspx?TopicId=" & ds3.Tables(0).Rows(sp).Item("id").ToString.Trim & "'>Read ( " & ds3.Tables(0).Rows(sp).Item("Comments").ToString.Trim & " comments)</a>"
            htmlString &= "       </td>"
            htmlString &= "       <td>"
            htmlString &= "           &nbsp;"
            htmlString &= "       </td>"
