...
Partial Class News_news_view
    ...
    Private Function CreateHTML() As String
        ...
        htmlString = "       <table style='width: 600px;' align='center'> "
        htmlString &= "    <tr>"
        htmlString &= "      <td >"
        htmlString &= "            &nbsp;"
        htmlString &= "       </td>"
    ...
    Private Sub PopulateTopics()
        ...
        Dim str3 As String = ""
        str3 = " SELECT  id, topic_heading"
        str3 &= "  FROM  forum_question"
        str3 &= "  WHERE Active = 'True' "
        str3 &= " ORDER BY  datetime DESC "
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        Response.Redirect("news_view.aspx?TopicId=" & GridView1.Rows(e.CommandArgument).Cells(0).Text)
    End Sub
End Class
