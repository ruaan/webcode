<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Association_Event_Control_App.aspx.vb" Inherits="Associations_Association_Event_Control_App" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="mainPageWrapper">
            <div class="div_MainBlock" style="text-align: left; align-content: center">
                ...
                <div id="divDetails" class="div_Details">
                    <div class="divDetails" style="font-size: x-large;">
                        Events for
                    ...
                    <asp:Panel ID="Panel1" runat="server" Width="100%" BorderColor="White">
        ...
        <asp:Button ID="btnBook" runat="server" BackColor="#394025" BorderStyle="None" />
        ...
        <asp:Button ID="btnRemove" runat="server" BackColor="#394025" BorderStyle="None" />
