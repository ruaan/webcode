Imports System.Data
Partial Class Associations_Association_Detail_Mobi
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Response.Redirect("Association_View_Mobi.aspx")
        End Try
    End Sub
    ...
    Private Sub GetNextEvent()
        ...
        Try
            If ds.Tables(0).Rows.Count > 0 Then
                lblNextEvent.Text = ds.Tables(0).Rows(0).Item("Event_Name").ToString.Trim
            Else
    ...
    Protected Sub btnBook_Click(sender As Object, e As EventArgs) Handles btnBook.Click
        Response.Redirect("Association_Event_View_Mobi.aspx?id=" & Request.QueryString("id"))
    End Sub
    Protected Sub btnJoin_Click(sender As Object, e As EventArgs) Handles btnJoin.Click
        Response.Redirect("RegistrationForm_App.aspx?AssId=" & Request.QueryString("id"))
    End Sub
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Response.Redirect("Member_Report_App.aspx?AssId=" & Request.QueryString("id") & "&memId=" & Request.Cookies("memberid").Value)
    End Sub
End Class
