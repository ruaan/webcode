Imports System.Data
Partial Class Associations_Association_Detail
    Inherits System.Web.UI.Page
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            Populate()
        Catch ex As Exception
            Response.Redirect("Association_View.aspx")
        End Try
    End Sub
    ...
    Protected Sub btnBook_Click(sender As Object, e As EventArgs) Handles btnBook.Click
        Response.Redirect("Association_Event_View.aspx?id=" & Request.QueryString("id"))
    End Sub
    Protected Sub btnJoin_Click(sender As Object, e As EventArgs) Handles btnJoin.Click
        Response.Redirect("RegistrationForm.aspx?AssId=" & Request.QueryString("id"))
    End Sub
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Response.Redirect("Member_Report.aspx?AssId=" & Request.QueryString("id") & "&memId=" & Request.Cookies("memberid").Value)
    End Sub
End Class
