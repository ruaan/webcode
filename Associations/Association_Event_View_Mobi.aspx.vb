Imports System.Data
Partial Class Associations_Association_Event_View_Mobi
    ...
    Private Function GetEvents() As String
        ...
        For sp = 0 To count
            If month <> CDate(dsTerms.Tables(0).Rows(sp).Item("EventDate").ToString.Trim).Month Then
                htmlString &= " <div style='background-color: #E2E2E2; font-size: 48px; font-weight: bold; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;'>"
            ...
            htmlString &= "     <div style='background-color: #F8F8F8; border: 1px solid #333333;  '>"
            htmlString &= "         <div style='padding: 10px; display: inline-block; vertical-align:top'>"
            htmlString &= " <div>  "
            htmlString &= " <div style='color: #37C4D6; font-weight: bold; font-size: 60px; text-align:center'>  "
            ...
            htmlString &= "             <div style='font-size: 48px; font-weight: bold;'>"
            ...
            If dsTerms.Tables(0).Rows(sp).Item("AcceptBooking").ToString.Trim = "True" Then
                ...
                If isGoing = "No" Then
                    htmlString &= "          <div id='divBtn' runat='server' style='padding: 5px; border: thin solid #333333;font-size: 48px;'>"
                    htmlString &= "             <input id='btnGoing' type='button' value='Going' style='border-style: none; background-color: #86B24F;  Cursor:pointer; font-size: 48px;' onclick=""Book('" & dsTerms.Tables(0).Rows(sp).Item("event_id").ToString.Trim & "','Attending') ""  />"
                    htmlString &= "             &nbsp;"
                    htmlString &= "             <input id='btnMaybe' type='button' value='Maybe' style='border-style: none; background-color: #E65B00;  Cursor:pointer; font-size: 48px;'  onclick=""Book('" & dsTerms.Tables(0).Rows(sp).Item("event_id").ToString.Trim & "','Maybe') ""  />"
                    htmlString &= "            </div>"
                ElseIf isGoing = "Maybe" Then
                    ...
                    htmlString &= "               <div>&nbsp;</div>"
                    htmlString &= "            <div>"
                    htmlString &= "             <input id='btnGoingA' type='button' value='Going' style='border-style: none; background-color: #86B24F;  Cursor:pointer; font-size: 48px;'  onclick=""Book('" & dsTerms.Tables(0).Rows(sp).Item("event_id").ToString.Trim & "','Attending') ""  />"
                    htmlString &= "             &nbsp;"
                    htmlString &= "             <input id='btnCancelA' type='button' value='Cancel' style='border-style: none; background-color: #E65B00;  Cursor:pointer; font-size: 48px;' onclick=""RemoveBook('" & dsTerms.Tables(0).Rows(sp).Item("event_id").ToString.Trim & "','Remove')"" />"
                    htmlString &= "            </div>"
                    htmlString &= "            </div>"
                ElseIf isGoing = "Attending" Then
                    ...
                    htmlString &= "               <div>&nbsp;</div>"
                    htmlString &= "            <div>"
                    htmlString &= "             <input id='btnCancel' type='button' value='Cancel' style='border-style: none; background-color: #E65B00;  Cursor:pointer; font-size: 48px;' onclick=""RemoveBook('" & dsTerms.Tables(0).Rows(sp).Item("event_id").ToString.Trim & "','Remove')"" />"
                    htmlString &= "            </div>"
                    htmlString &= "            </div>"
                End If
            End If
