<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageGreenLF.master" AutoEventWireup="false" CodeFile="farm_Edit_Profile.aspx.vb" Inherits="Farms_farm_Edit_Profile" %>
        ...
        <div class="div_MainBlock">
            <div style="text-align: left; width: 1050px; display: inline-block;">
                ...
                <div>
                    ...
                    &nbsp;Farms: <asp:DropDownList ID="cmbFarms" runat="server" AutoPostBack="True" DataTextField="FarmName" DataValueField="id"></asp:DropDownList></asp:Panel></div>
                <div>&nbsp; <asp:Label ID="lblFarmId" runat="server"></asp:Label>&nbsp;<asp:Label ID="lblFarmName" runat="server"></asp:Label>
                </div>
                <div id="divAllBlock" runat="server" style="display: inline-block">
                <div id="divDetails" runat="server" style="border-width: thin; border-color: #838383; display: inline-block; vertical-align: top; padding-right: 20px; border-right-style: solid;" class="auto-style4">
                    ...
                    <div id="divDescriptHdr">
                        ...
                        <asp:Panel ID="pnlTerrain" runat="server" Visible="False" Width="648px">
                            ...
                            <div>&nbsp;</div>
                            <div style="text-align: right">
                               <asp:Label ID="lblUpdateTerrainMsg" runat="server"></asp:Label> <asp:Button ID="btnUpdateTerrain" runat="server" Text="Update" CssClass="buttonUpdate" />                                <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/Icons/correct.png" Visible="False" />
                ...
                <div id="divFacilitiesHdr" runat="server" visible="false">
                    ...
                    <asp:Panel ID="pnlFacilitiesDetail" runat="server" Visible="False" Width="650px">
                            ...
                            <div>
                                <asp:GridView ID="grdFacilities" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="sqlFacilities" GridLines="None">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ChkFacility" runat="server" /></ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                            ...
                            <div>&nbsp;</div>
                            <div style="text-align: right">
                                <asp:Label ID="lblFacilitySubmitMsg" runat="server"></asp:Label><asp:Button ID="btnUpdateFacilities" runat="server" Text="Update" CssClass="buttonUpdate" /><asp:Image ID="Image3" runat="server" ImageUrl="~/Images/Icons/correct.png" Visible="False" /></div>
                          <div class="auto-style10">&nbsp;</div>
                    ...
                    <asp:Panel ID="pnlSpecificFeatures" runat="server" Width="650px" Visible="False">
                            ...
                            <div id="divAddBtn"  runat="server">
                                ...
                                <asp:Button ID="btnAddAdditional" runat="server" Text="Add" CssClass="buttonUpdate"  /></div>
                             <div>&nbsp;</div>
                            <div id="divAddService" runat="server" visible="false" class="textbox">
                                <div>Description:&nbsp;<asp:TextBox ID="txtAdditServiceDesc" runat="server" CssClass="textbox" Width="390px" MaxLength="50"></asp:TextBox> max 50 characters</div>
                                <div>
                                    <asp:CheckBox ID="chkAddCharge" runat="server" TextAlign="Left" Text="Additional charge?" AutoPostBack="True" /></div>
                                <div id="divAdditionalCharge" runat="server" visible ="False">
                                 <div>Price:&nbsp;<asp:TextBox ID="txtAdditPrice" runat="server" CssClass="textbox" Width="90px"></asp:TextBox></div>
                                    <div>Unit:&nbsp;<asp:TextBox ID="txtAdditUnit" runat="server" CssClass="textbox" Width="51px"></asp:TextBox> </div>
                                    </div>
                                 <div style="text-align: center">
                                <asp:Button ID="btnUpdateAddService" runat="server" Text="Update" CssClass="buttonUpdate" /> &nbsp;<asp:Button ID="Button2" runat="server" Text="Cancel" CssClass="buttonUpdate" /><asp:Label ID="lblUpdateAddServiceMsg" runat="server"></asp:Label></div>
                            <div>&nbsp;</div>
                            </div>
                             <div>&nbsp;</div>
                           <div id="AddGrid">
                    ...
                    <div style="display:inline-block;">
                        <div style="padding-right: 0px; padding-bottom: 5px; padding-left: 5px" class="auto-style12">
                            <asp:Image ID="imgSideTop" runat="server" ImageUrl="~/Farms/Albums/test/lk;k/farms-lodges_22.gif" Height="127px" Width="127px" /></div>
                         <div style="padding-right: 0px; padding-bottom: 5px; padding-left: 5px" class="auto-style12">
                            <asp:Image ID="imgSidemiddel" runat="server" ImageUrl="~/Farms/Albums/test/lk;k/farms-lodges_23.gif" Height="127px" Width="127px" /></div>
                         <div style="padding-right: 0px; padding-bottom: 0px; padding-left: 5px" class="auto-style12">
                            <asp:Image ID="imgSideBottom" runat="server" ImageUrl="~/Farms/Albums/test/lk;k/farms-lodges_22.gif" Height="127px" Width="127px" /></div>
                    </div>
                        
                </div>
                                                <div>&nbsp;</div>
                        <div>
                       What Picture are you uploading: &nbsp; <asp:DropDownList ID="cmbPicType" runat="server" CssClass="textbox">
                    ...
                    <div>&nbsp;</div>
                            <asp:FileUpload ID="FileUpload1" runat="server" /><div>
                                <asp:Button ID="btnUploadProfilePic" runat="server" Text="Upload" CssClass="nextPrevButton" /><asp:Label ID="lblUploadMsg" runat="server"></asp:Label></div>
                    ...
                    <asp:Panel ID="pnlHuntingSeason" runat="server" Visible="False" Width="650px">
                            ...
                            <div>&nbsp;</div>
                            <div style="text-align:center" class="divFormMng">
                            <div>Minimum qty of hunters per booking: 
                            ...
                            <div style="text-align: right">
                                ...
                                <asp:Button ID="btnUpdateAmenities" runat="server" Text="Update" CssClass="buttonUpdate" /><asp:Image ID="Image4" runat="server" ImageUrl="~/Images/Icons/correct.png" Visible="False" /></div>
                    ...
                    <asp:Panel ID="pnlHuntingTypes" runat="server" Visible="False" Width="650px">
                            ...
                            <div>
                                <asp:GridView ID="grdHunting" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlHuntingTypes" GridLines="None">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ChkHuntingType" runat="server" /></ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                            ...
                            <div style="text-align: right">
                                ...
                                <asp:Button ID="btnUpdateHunting" runat="server" Text="Update" CssClass="buttonUpdate" /><asp:Image ID="Image5" runat="server" ImageUrl="~/Images/Icons/correct.png" Visible="False" /></div>
                    ...
                    <div id="divecoTourism">
                        <asp:Panel ID="Panel1" runat="server" Visible="False" Width="650px">
                            ...
                            <div>
                                <asp:GridView ID="grdEcoTourism" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlEcoTourism" GridLines="None">
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="ChkEcoTourismType" runat="server" /></ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                            ...
                            <div style="text-align: right">
                                ...
                                <asp:Button ID="btnUpdateEcoTourism" runat="server" Text="Update" CssClass="buttonUpdate" /><asp:Image ID="Image6" runat="server" ImageUrl="~/Images/Icons/correct.png" Visible="False" /></div>
                        ...
                        <asp:Panel ID="pnlTerms" runat="server" Visible="False">
                            <div>&nbsp;</div>
                            <div>
                                <div>Hunter Daily Rate: <asp:TextBox ID="txtHunterRate" runat="server"></asp:TextBox></div>
                            </div>
                             <div>&nbsp;</div>
                             <div>
                                <div>Guest Daily Rate: <asp:TextBox ID="txtGuestRate" runat="server"></asp:TextBox></div>
                            </div>
                             <div>&nbsp;</div>
                             <div>
                                <div>Deposit % (only on daily rates): <asp:TextBox ID="txtDepositPerc" runat="server"></asp:TextBox>%</div>
                            </div>
                            <div>&nbsp;</div>
                             <div>
                                <div>Deposit waiting period: <asp:TextBox ID="txtDepositPeriod" runat="server"></asp:TextBox> Days.</div>
                            </div>
                             <div>&nbsp;</div>
                            
                            <div>
                                Booking System: <asp:CheckBox ID="CheckBox1" runat="server" Text="Allow booking without date confirmation email:" TextAlign="Left" /></div>
                             <div>&nbsp;</div>
                            <div>Payfast Merchant No: <asp:TextBox ID="txtPayfast" runat="server"></asp:TextBox></div>
                            <div>Don't have a Payfast accounnt? <a href="https://www.payfast.co.za/user/register">Cick here to create your free account.</a></div>
                             <div>&nbsp;</div>
                            <div>
                                <asp:Button ID="btnRateUpdate" runat="server" Text="Update" CssClass="button" /></div>
                            <div>&nbsp;</div>
                            <div>
                                <asp:Label ID="lblTermsMsg" runat="server"></asp:Label></div>
                            <div>&nbsp;</div>
                            <div class="h1">
                                Price Includes:
                            </div>
                            <div>
                                <asp:TextBox ID="txtPriceIncludes" runat="server" CssClass="textbox" Width="423px"></asp:TextBox>&nbsp; <asp:Button ID="Button3" runat="server" Text="Add" CssClass="lineButton" /></div>
                            <div>
                            ...
                            <div>&nbsp;</div>
                             ...
                             <div>
                                <asp:TextBox ID="txtPriceDoesnot" runat="server" CssClass="textbox" Width="423px"></asp:TextBox>&nbsp; <asp:Button ID="Button4" runat="server" Text="Add" CssClass="lineButton" /></div>
                            <div>
                            ...
                            <div>
                                 <div>
                                <asp:TextBox ID="txtTermsPayment" runat="server" CssClass="textbox" Width="423px"></asp:TextBox>&nbsp; <asp:Button ID="Button5" runat="server" Text="Add" CssClass="lineButton" /></div>
                            ...
                            <div>&nbsp;</div>
                             ...
                             <div>
                                <asp:TextBox ID="txtCanselation" runat="server" CssClass="textbox" Width="423px"></asp:TextBox>&nbsp; <asp:Button ID="Button6" runat="server" Text="Add" CssClass="lineButton" /></div>
                            <div>
                            ...
                            <div>&nbsp;</div>
                             ...
                             <div>
                                <asp:TextBox ID="txtWounding" runat="server" CssClass="textbox" Width="423px"></asp:TextBox>&nbsp; <asp:Button ID="Button7" runat="server" Text="Add" CssClass="lineButton" /></div>
                            <div>
                ...
                <div style="display: inline-block; vertical-align: top; padding-left: 20px;">
                    <div>
                        <asp:Button ID="Button1" runat="server" Text="Account Management" BackColor="White" BorderStyle="None" /></div>
                    <div>&nbsp;</div>
                    <div>&nbsp;</div>
                </div>
...
<%--</ContentTemplate></asp:UpdatePanel>--%>
    ...
    <script type="text/javascript">
        ...
        function ToggleDetails(pnlDiv, imgDown, imgUp) {
            ...
            //if (sessionStorage.getItem(pnlDiv) == 'none') {
            //    sessionStorage.getItem(pnlDiv);
            //    pnlDiv.css("display", "inline-block")

            //    sessionStorage.setItem(pnlDiv, pnlDiv.css("display"));
