<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageGreenLF.master" AutoEventWireup="false" CodeFile="frmPackagesManager.aspx.vb" Inherits="Farms_frmPackagesManager" %>
                ...
                <tr>
                    <td>
                        <table width="100%" align="center" cellpadding="0" cellspacing"0">
                            ...
                            <tr>
                                <td height="27">Animals Included:</td>
                                <td>
                                    <asp:DropDownList ID="ddlAnimals" runat="server" Width="250px" 
                                        DataTextField="Name" DataValueField="id">
                                    </asp:DropDownList>&nbsp;&nbsp;&nbsp;<asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="button" Width="80px" />
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td align="left">
                                    <asp:GridView ID="grdAnimals" runat="server" AutoGenerateColumns="False" BorderStyle="solid" Font-Size="x-Small" Width="500px" ShowHeader="False">
                                        <Columns>
                                            <asp:BoundField DataField="animalId">
