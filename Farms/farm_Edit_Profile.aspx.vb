Imports System.IO
Imports System.Data
Partial Class Farms_farm_Edit_Profile
...
#End Region
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Response.Redirect("FarmAccDetails.aspx?frmid=" & lblFarmId.Text.Trim)
    End Sub
    ...
    Protected Sub btnRateUpdate_Click(sender As Object, e As EventArgs) Handles btnRateUpdate.Click
        ...
        cmd.Parameters.AddWithValue("@Payfast", txtPayfast.Text.Trim)
        ...
        str &= " SET HunterPrice = @HunterPrice, GuestPrice = @GuestPrice, Payfast = @Payfast "
        str &= " WHERE (FarmId = @FarmId) "
        str &= " END "
        str &= " ELSE "
        str &= " BEGIN "
        ...
        str &= " (FarmId, HunterPrice, GuestPrice, Payfast)"
        str &= " VALUES "
        str &= " (@FarmId, @HunterPrice, @GuestPrice, @Payfast)"
        str &= " END  "
        str &= " COMMIT TRAN"
