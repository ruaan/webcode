        ...
        Try
            ...
            If farmCount > -1 Then
                ...
                For farmSp = 0 To farmCount
                    htmlString &= "                    <div id='famrid" & dsFarm.Tables(0).Rows(farmSp).Item("id").ToString.Trim & " ' class='div_Farm_Block'  onclick=""window.open('package_view.aspx?id=" & dsFarm.Tables(0).Rows(farmSp).Item("packageId").ToString.Trim & "', '_blank')"">"
