...
Imports System.IO
Partial Class Reserve_Confrim_App
    ...
    Private Function ConfirmationBody(HuntId As String) As String
        ...
        htmlString &= "                                 </tr>"
        htmlString &= "                                 <tr>"
        htmlString &= "                                     <td align='center' class='auto-style2' style='background-color: #86B24F'><a href=""www.ecohunter-app.co.za/Reserve_DateConfirm.aspx?a=T&h=" & HuntId & """ Style ='cursor: pointer'>Availability Confirm</a></td>"
        htmlString &= "                                     <td class='auto-style5'></td>"
        htmlString &= "                                    <td align='center' class='auto-style2' style='background-color: #86B24F'><a href=""www.ecohunter-app.co.za/Reserve_DateConfirm.aspx?a=F&h=" & HuntId & """ Style ='cursor: pointer'>Not Available</a></td>"
        htmlString &= "                                 </tr>"
        htmlString &= "                                 <tr>"
        htmlString &= "                                     <td class='auto-style1'>&nbsp;</td>"
        htmlString &= "                                     <td class='auto-style4'>&nbsp;</td>"
    ...
    Protected Sub ImageButton2_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton2.Click
        Response.Redirect("~/Members/Hunts_Detail_App.aspx?h=" & Request.QueryString("HuntId"))
    End Sub
