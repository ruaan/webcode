    ...
    Private Function ResultBody() As String
        ...
        If farmCount > -1 Then
            ...
            For farmSp = 0 To farmCount
                ...
                htmlString &= "     <div class='div_Picture_Style' onclick=""window.open('outfitter_view.aspx?id=" & dsFarm.Tables(0).Rows(farmSp).Item("id").ToString.Trim & "', '_blank')"">"
                ...
                htmlString &= "     </div>"
                htmlString &= "     <div class='div_Middle_Block' onclick=""window.open('outfitter_view.aspx?id=" & dsFarm.Tables(0).Rows(farmSp).Item("id").ToString.Trim & "', '_blank')"">"
