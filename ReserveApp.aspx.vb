...
Partial Class ReserveApp
    ...
    Private Sub Reserve_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            Try
                ...
                cntId = "1"
            Catch ex As Exception
                Response.Redirect("farm_view_app.aspx")
            End Try
        ...
        PlaceHolderHunters.Controls.Add(New LiteralControl(GetHuntMembersdiv()))
    End Sub
    ...
    Private Sub PopulateFarmAnimals(FarmId As String, CountryId As String)
        ...
        Dim str As String = ""
        str &= " SELECT        dbo.tbl_Farm_Animal.id, dbo.tbl_Animals.Name, dbo.tbl_Farm_Animal.AnimalId, dbo.tbl_Farm_Animal.AvailableToHunt, dbo.tbl_Farm_Animal.Male_Price, dbo.tbl_Farm_Animal.Female_Price, dbo.tbl_Farm_Animal.Trophy_Price, "
        str &= "                          dbo.tbl_Farm_Animal.Inches, dbo.tbl_Farm_Animal.Visiting_Country, dbo.tbl_Farm_Animal.Active"
        str &= " FROM            dbo.tbl_Farm_Animal INNER JOIN"
        str &= "                          dbo.tbl_Animals ON dbo.tbl_Farm_Animal.AnimalId = dbo.tbl_Animals.id"
        str &= " WHERE        (dbo.tbl_Farm_Animal.FarmId = @FarmId) AND (dbo.tbl_Farm_Animal.Active = 'True') AND (dbo.tbl_Farm_Animal.AvailableToHunt = 'True') AND (dbo.tbl_Farm_Animal.Visiting_Country = @VisitingCountry)"
        str &= " ORDER BY dbo.tbl_Animals.Name"
    ...
    Private Function GetBillingBody() As String
        ...
        Dim DepositPercent As Double = 10
        Try
            DepositPercent = HiddenFieldDepositPercentage.Value
        Catch ex As Exception

        End Try
        Dim DepositWaitingPeriod As Double = 20
        Try
            DepositWaitingPeriod = HiddenFieldDepositPeriod.Value
        Catch ex As Exception
    ...
    Private Sub PopulateFarm(FarmId As String)
        ...
        imgFarm.ImageUrl = "Farms/Images/FarmProfiles/" & FarmId.Trim & "main.jpg"
    ...
    Private Sub StartSave()
        ...
        Next
        Response.Redirect("Reserve_Confrim_App.aspx?HuntId=" & HuntId)
