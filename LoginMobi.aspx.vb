...
Partial Class LoginMobi
    ...
    Private Function GetUser(UserName As String, Password As String) As String()
        ...
        Catch ex As Exception
            lblPasswordVal.Text = ex.Message
        Finally
            myconnection.Close()
        End Try
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If txtUserName.Text = "" Then
            lblPasswordVal.Text = "* User Name is required."
        End If
        If txtPassword.Text = "" Then
            lblPasswordVal.Text = "</br>* Password is required."
        End If

        If lblPasswordVal.Text = "" Then
            ...
            Else
                lblPasswordVal.Text &= "Your login attempt was not successful. Please try again."
            End If
        End If
    End Sub
