<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReserveApp.aspx.vb" Inherits="ReserveApp" %>
...
<body>
    <form id="form1" runat="server" autocomplete="off">
        ...
        <div style="font-family: Calibri">
            <div class="h1" style="background-color: #E5E3E5">Your Hunting Trip<asp:Label ID="Label1" runat="server" Text="Label" ForeColor="#E5E3E5"></asp:Label></div>
            <div>&nbsp;</div>
            <div style="display: inline-block; vertical-align: top" class="auto-style6">
                ...
                <div>&nbsp;</div>
                <div style="padding-left: 10px; background-color: #F8F8F8; font-family: Calibri; color: #333333;">
                    <div>&nbsp;</div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <cc1:ModalPopupExtender ID="btnAddMember_ModalPopupExtender" runat="server" BehaviorID="btnAddMember_ModalPopupExtender" Drag="True" DropShadow="True" PopupControlID="pnlAddMember" PopupDragHandleControlID="pnladdMemberHandle" RepositionMode="None" TargetControlID="btnAddMember">
                ...
                <div>
                    <asp:Panel ID="pnlEcoMemberYes" runat="server" Visible="False" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px">
                        ...
                        <div style="padding-left: 5px">
                            ...
                            <asp:Button ID="btnMemberSearch" runat="server" BackColor="White" BorderStyle="None" ForeColor="#86B24F" Style="cursor: pointer; height: 22px;" Text="Search" />
                        </div>
                        <div>&nbsp;</div>
                        <div id="divEcoMember">
            ...
            <div style="padding-left: 10px">
                <div>
                    Only add species that will be for your account.<br>
                        <br></br>
                        <br></br>
                        Eco-Hunter members in your party will receive an Email inviting them to add species to their account.<br></br>
                    </br>
                </div>
                <div>
                    &nbsp<asp:Label ID="lblSpeciesMsg" runat="server"></asp:Label>
                </div>
                <div style="text-align: center">
