...
Partial Class Animals_App
    ...
    Private Function GetAnimals() As String
        ...
        For sp = 0 To count
            ...
            htmlString &= "     <div style='background-color: #F8F8F8; border: 1px solid #333333;  cursor:pointer;' onclick= ""location.href = 'Animal_View_App.aspx?animalId=" & dsTerms.Tables(0).Rows(sp).Item("id").ToString.Trim & "'"" >"
            htmlString &= "         <div style='padding: 10px; display: inline-block; width:100px;height:100px;'>"
    ...
    Private Function LoadAnimalQuery() As String
        ...
        htmlString &= " <div>"
        htmlString &= " <input type='text' id='demo-input-local' name='blah' style='font-size: large' />"
