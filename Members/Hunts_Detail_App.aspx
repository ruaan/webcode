<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Hunts_Detail_App.aspx.vb" Inherits="Members_Hunts_Detail_App" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="mainPageWrapper" style="align-content: center;">
            <div class="div_MainBlock">
                    ...
                    <div style="vertical-align: top">
                        <div style="display: inline-block; vertical-align: top" class="auto-style6">
                            ...
                            <div style="padding-left: 10px">
                                <div style="vertical-align: top">
                                    Trip Name:
                            <asp:TextBox ID="txtUniqueName" runat="server" Width="95%" CssClass="textbox"></asp:TextBox>
                                    &nbsp;<asp:Button ID="btnSaveName" runat="server" BackColor="White" BorderStyle="None" ForeColor="#86B24F" Text="Save" Style="cursor: pointer" />
                                </div>
                                <div>&nbsp;</div>
                                <div>
                                    <asp:Label ID="lblSplit" runat="server" Text="You can split the bill between members."></asp:Label>
                                    <div style="background-color: #9AB37A; color: #FFFFFF;">
                                        Members of the party
                                    </div>
                                    <div>
                                        <div>&nbsp;</div>
                                        <asp:Button ID="btnAddMember" runat="server" BackColor="White" BorderStyle="None" ForeColor="#86B24F" Text="Add Member" Style="cursor: pointer" OnClientClick="popOpen('divAddMemberPopup')" />

                                        <cc1:ModalPopupExtender ID="btnAddMember_ModalPopupExtender" runat="server" BehaviorID="btnAddMember_ModalPopupExtender" Drag="True" DropShadow="True" DynamicServicePath="" PopupControlID="pnlAddMember" PopupDragHandleControlID="pnladdMemberHandle" RepositionMode="None" TargetControlID="btnAddMember">
                                        ...
                                        <div>
                                            <asp:PlaceHolder ID="PlaceHolderHunters" runat="server"></asp:PlaceHolder>
                                        </div>
                                        <div>
                ...
                <div class="auto-style4" style="background-color: #E5E3E5">
                    <%-- <div class="div_AccountHeading">Total Due</div>
                            <div>
                                <div class="div_Totals">
                                    <div><strong>Total</strong></div>
                                    <div>R14 368.00</div>
                                </div>
                                <div class="div_YourAccount">
                                    <div><strong>For your account</strong></div>
                                    <div>R14 368.00</div>
                                </div>
                                <div class="div_AccountHeading">Deposit</div>
                                <div class="div_Totals">

                                    <div>R3 627.00</div>

                                </div>
                                <div style="display: inline-block; background-color: #C0C0C0; padding-bottom: 5px" class="div_YourAccount">

                                    <div>R3 627.00</div>

                                </div>
                                <div style="font-size: small; color: #666666; padding-bottom: 5px;">Pay deposit before 28/12/2017.</div>
                                <div class="div_AccountHeading">Final payment</div>
                            ...
                            <div style="border-bottom-style: solid; border-width: thin; border-color: #333333">&nbsp;</div>
                            <div>&nbsp;</div>
                            <div class="div_AccountSubHeading">Accommodation</div>
                            <div class="div_Totals">
                                <div>R14 368.00</div>
                            </div>
                            <div class="div_YourAccount">
                            ...
                            <div class="div_AccountSubHeading">Additional</div>
                            <div class="div_Totals">
                                <div>R7 868.00</div>
                            </div>
                            <div class="div_YourAccount">
        ...
        <asp:Panel ID="pnlAddMember" runat="server" BackColor="White" BorderColor="#333333" BorderStyle="Solid" BorderWidth="1px">
            <asp:Panel ID="pnladdMemberHandle" runat="server" BackColor="#9AB37A" ForeColor="White">Add member to your Party.</asp:Panel>
            <div style="padding-left: 5px">
                ...
                <div>&nbsp;</div>
                <div>
                    <asp:Panel ID="pnlEcoMemberYes" runat="server" Visible="False" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px">
                        <div>&nbsp;</div>
                        <div style="padding-left: 5px">
                        ...
                        <div id="divEcoMember">
                            <asp:Panel ID="pnlMemberDetails" runat="server" Visible="False">
                                ...
                                <div id="divMemberDetails" style="padding-left: 5px">
                                    <asp:Panel ID="pnlMember2Add" runat="server">
                                        ...
                                        <div style="display: inline-block; padding-left: 10px;">
                                            <asp:Label ID="lblId2Add" runat="server"></asp:Label>
                                            &nbsp; &nbsp;
                             ...
                             <asp:Label ID="lblEmailtoAdd" runat="server" Text=""></asp:Label>&nbsp;
                                        </div>
                                        <div>
                                            <asp:Label ID="lblHunterType" runat="server"></asp:Label>
                                        </div>
                                        <div>
                    ...
                    <asp:Panel ID="pnlEcoMemberNo" runat="server" Visible="False" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px">
                        <div id="divNonEcoMember">
                            <div>&nbsp;</div>
                            <div>Non Eco-Hunter Members bill will be for your account.</div>
                            <div>&nbsp;</div>
                            <div>Name:
                                <asp:TextBox ID="txtNonMemberName" runat="server"></asp:TextBox></div>
                            <div>
                                Hunter Type:
        ...
        <asp:Panel ID="pnlAddSpecies" runat="server" BackColor="White">
            <asp:Panel ID="pnlSpeciesHandle" runat="server" BackColor="#9AB37A" ForeColor="White">Add Species.</asp:Panel>
            <div style="padding-left: 10px">
                <div>
