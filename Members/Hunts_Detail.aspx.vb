Imports System.Data
Partial Class Members_Hunts_Detail
    ...
    Private Sub Reserve_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            cntId = "1"
        Catch ex As Exception
            Response.Redirect("My_Hunts.aspx")
        End Try
    ...
    Protected Sub GridView1_DataBound(sender As Object, e As EventArgs) Handles GridView1.DataBound
        ...
        For sp = 0 To count
            ...
            If GridView1.Rows(sp).Cells(0).Text.Trim = MemberId Then
    ...
    Protected Sub btnReserve_Click(sender As Object, e As EventArgs) Handles btnReserve.Click
        ...
        ElseIf btnReserve.Text = "Pay Deposit" Then
            Response.Redirect("~/Payment/PaymentConfirmation.aspx?h=" & Request.QueryString("h"))
        End If
    ...
    Private Function InitialHuntSave() As String
        ...
        Try
            ...
            da.SelectCommand = cmd
            da.Fill(ds, "Auto")
            SaveMembers(ds.Tables(0).Rows(0).Item(0).ToString.Trim)
    ...
    End Function
    Private Function GetHuntMembers(huntId As String) As DataSet
        Dim myconnection As New SqlClient.SqlConnection
        myconnection.ConnectionString = Web.Configuration.WebConfigurationManager.ConnectionStrings.Item("MainConnection").ToString
        Dim cmd As New SqlClient.SqlCommand
        ...
        For sp = 0 To count
            If ds.Tables(0).Rows(sp).Item("MemberId").ToString.Trim = "Guest" Then
                HunterGuest = "Guest"
            Else
                HunterGuest = "Hunter"
            End If

            If ds.Tables(0).Rows(sp).Item("Type").ToString.Trim = "&nbsp;" Then
                huntType = ""

            End If

            AddMemberTable(ds.Tables(0).Rows(sp).Item("MemberId").ToString.Trim, ds.Tables(0).Rows(sp).Item("Name").ToString.Trim, ds.Tables(0).Rows(sp).Item("OwnAccount").ToString.Trim, huntType, HunterGuest)
        Next
