Imports System.Data
Partial Class Members_Dashboard_App
    ...
    Private Function LoadBanner() As String
        ...
        If newsCount > -1 Then
            ...
            For spNews = 0 To newsCount
                htmlString &= "     <div  style='background:#E2E2E2; width: 100%;'   onclick=""location.href = '../../News/news_viewsApp.aspx?TopicId=" & dsNews.Tables(0).Rows(spFarms).Item("id").ToString.Trim & "'"">"
                htmlString &= "         <div>"
                htmlString &= "             <div style='display: inline-block;' class='auto-style1'>"
        ...
        For spFarms = 0 To farmCount
            ...
            If System.IO.File.Exists(SavePath & dsNewFarm.Tables(0).Rows(spFarms).Item("id").ToString.Trim & "Main.jpg") Then
                ...
                htmlString &= "        onclick=""location.href = '../../farm_view_app.aspx?id=" & dsNewFarm.Tables(0).Rows(spFarms).Item("id").ToString.Trim & "'"">"
            Else
