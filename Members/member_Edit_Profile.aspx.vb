Imports System.IO
Imports System.Data
Partial Class Members_member_Edit_Profile
...
#End Region
    ...
    End Sub
    Protected Sub btnPasswordSave_Click(sender As Object, e As EventArgs) Handles btnPasswordSave.Click
        lblPassword.Text = ""
        If ConfirmPassword() = True Then
            If txtnewPassword.Text.Trim = txtConfirmPassword.Text.Trim Then
                UpdatePassword()
            Else
                lblPassword.Text = "Passwords does not match."
            End If
        Else
    ...
    Private Function ConfirmPassword() As Boolean
        Dim myconnection As New SqlClient.SqlConnection
        myconnection.ConnectionString = Web.Configuration.WebConfigurationManager.ConnectionStrings.Item("MainConnection").ToString
        Dim cmd As New SqlClient.SqlCommand
        ...
        Dim str As String = ""
        str = "  SELECT   id, UserId, Password"
        str &= "  FROM            tbl_Password"
        ...
        Dim PasswordValidate As Boolean


        Try
            If ds.Tables(0).Rows(0).Item("Password").ToString.Trim = txtOldPassword.Text.Trim Then
    ...
    Private Sub UpdatePassword()
        ...
        Dim str As String = ""
        str = "  Update tbl_Password"
        str &= " Set Password = @Password"
        str &= " WHERE (UserId = @UserId)"
