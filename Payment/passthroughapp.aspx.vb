...
Partial Class passthroughapp
    ...
    Protected Sub PostData(HuntId As String)
        ...
        collections.Add("return_url", "http://ecohunter-app.co.za/Payment/PaymentSuccessApp.aspx?h=" & thisData.Tables(0).Rows(0).Item("Hunts_Id").ToString.Trim & "&M=" & thisData.Tables(0).Rows(0).Item("Id").ToString.Trim)
        collections.Add("cancel_url", "http://ecohunter-app.co.za/Payment/PaymentCancelApp.aspx?h=" & thisData.Tables(0).Rows(0).Item("Hunts_Id").ToString.Trim & "&M=" & thisData.Tables(0).Rows(0).Item("Id").ToString.Trim)
        collections.Add("notify_url", "http://ecohunter-app.co.za/Payment/PaymentNotifyApp.aspx?h=" & thisData.Tables(0).Rows(0).Item("Hunts_Id").ToString.Trim & "&M=" & thisData.Tables(0).Rows(0).Item("Id").ToString.Trim)
