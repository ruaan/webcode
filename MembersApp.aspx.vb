    ...
    Private Function ResultBody() As String
        ...
        If farmCount > -1 Then
            ...
            For farmSp = 0 To farmCount
                ...
                htmlString &= "                    <div id='famrid" & dsFarm.Tables(0).Rows(farmSp).Item("MemberId").ToString.Trim & " ' class='div_Farm_Block'  onclick=""location.href = 'members_view_app.aspx?id=" & dsFarm.Tables(0).Rows(farmSp).Item("MemberId").ToString.Trim & "'"">"
        ...
        Else
            htmlString &= "                         <div style='background-color: #F0F0F0' class='div_Farm_header'>"
