<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageGreenLF.master" AutoEventWireup="false" CodeFile="HuntingTypeManager.aspx.vb" Inherits="SetUp_HuntingTypeManager" %>
        ...
        <ContentTemplate>
            <div class="divPagewide">
                <div class="divMainContainer">
                    ...
                    <div class="yellowHeader">Hunting Types:</div>
                    <div>&nbsp;</div>
                    <div>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EmptyDataText="No Hunting Types available to select">
                            <Columns>
                                ...
                                <asp:BoundField DataField="HuntingType" HeaderText="Huntingtype" />
                ...
                <div id="pnlDetail" visible="false" runat="server" class="divFormMng">
                    ...
                    <div align="left" id="Div1" runat="server" style="border-left-style: solid; border-width: thin; border-color: #FFD42A; border-bottom-style: solid;">
                        ...
                        <div>
                            Hunting Type:&nbsp;
                                        <asp:TextBox ID="txtHuntingType" runat="server" MaxLength="200" CssClass="textbox"></asp:TextBox>
