<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageGreenLF.master" AutoEventWireup="false" CodeFile="OutfitterPackageManager.aspx.vb" Inherits="SetUp_OutfitterPackageManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table align="center" style="width: 100%;">
        <tr>
            <td height="40" align="left">Outfitter Package Manager</td>
        </tr>
        <tr>
            <td>
                        ...
                        <td>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EmptyDataText="No packages available to select" Font-Names="Verdana" Font-Size="Small" Width="50%">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="farmId" HeaderText="Lodge Id" />
