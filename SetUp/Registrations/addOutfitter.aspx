<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageGreenLF.master" AutoEventWireup="false" CodeFile="addOutfitter.aspx.vb" Inherits="SetUp_Registrations_addOutfitter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div valign="top" style="clip: rect(0px, auto, auto, auto);">
                <div id="pnlFarmDetails" runat="server" class="auto-style8" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;">
                    <div class="divFormMng">
                        <div class="h1">Outfitter Details</div>
                        <div>&nbsp;</div>
                        <div>
                            <div>Outfitter Name</div>
                            <div>
                        ...
                        <div class="divFormMng">
                            <div>Province</div>
                            <div>
                                <asp:DropDownList ID="cmbProvince" runat="server" CssClass="textbox" DataSourceID="SqlDataSourceProvince" DataTextField="Name" DataValueField="ProvinceId" Visible="False"></asp:DropDownList>
                        ...
                        <div class="divFormMng">
                            ...
                            <div>
                                <asp:TextBox ID="txtClosestTown" runat="server" CssClass="textbox" Visible="False"></asp:TextBox>
            ...
            <div id="pnlUserDetails" runat="server" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;" visible="False">
