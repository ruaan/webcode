Imports System.Data
Partial Class SetUp_Registrations_addFarm
...
#End Region
    ...
    Private Sub ValidatePage()
        ...
        End If
        '///Valudation Requested to be switched off
        ...
        Else
            ...
            Try
                ...
                ElseIf Request.Cookies("UserType").Value.Trim = "Farm Super" Then
                    Response.Redirect("../../Farms/farm_Edit_Profile.aspx")
                Else
                    Response.Redirect("../../Farms/farm_Edit_Profile.aspx")
                End If
            Catch ex As Exception
                Response.Cookies("UserType").Value = "Farm Super"
