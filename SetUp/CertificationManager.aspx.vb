Imports System.Data
Partial Class SetUp_CertificationManager
    ...
    Private Sub PopulateList()
        ...
        Dim str As String = ""
        str = " SELECT * "
        str &= " FROM  tbl_Certificate_Descriptions "
    ...
    Private Sub AddDescription()
        ...
        Dim str As String = ""
        str = " INSERT INTO tbl_Certificate_Descriptions "
        str &= " (Description, Active) VALUES (@Description, @Active)"
    ...
    Private Sub UpdateDescription()
        ...
        Dim str As String = ""
        str = " UPDATE tbl_Certificate_Descriptions "
        str &= " SET Description = @Description, Active = @Active"
        str &= " Where id = @Id"
