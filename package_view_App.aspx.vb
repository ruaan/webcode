Imports System.Data
Partial Class package_view_App
...
#Region "Package Information"
    ...
    Private Function GetGeninfo() As String
        ...
        htmlString &= "                 <div>&nbsp;</div>"
        htmlString &= "                 <div style='display:inline-block; width: 100%;  padding: 2px; vertical-align: top;'>"
        htmlString &= "                     <div >" & dsInfo.Tables(0).Rows(0).Item("Description").ToString.Trim & "</div>"
        htmlString &= "                     <div>&nbsp;</div>"
        htmlString &= "                 <div style ='horizontal-align: right; vertical-align: middle;  padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("LargeImage").ToString.Trim <> "" Then
            htmlString &= "                     <img alt='' src='Farms/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("LargeImage").ToString.Trim & "' class='Animal_Pic' />"
        Else
            htmlString &= "                     <img alt='' src='Farms/Images/Packages/TemplateBig.jpg' />"
        End If
        htmlString &= "                 </div>"
        htmlString &= "                 <div>&nbsp;</div>"
        htmlString &= "                     <div style= 'width: 100%; font-weight: 700;'>Animals Included:</div>"
        htmlString &= "                     <div>&nbsp;</div>"
        ...
        If certCount > -1 Then
            For sp = 0 To certCount
                ...
                htmlString &= "                             <div style='width: 100px;'>" & dsCertificate.Tables(0).Rows(sp).Item("Name").ToString.Trim & "</div>"
                htmlString &= "                         </div>"
                htmlString &= "                     </div>"
            Next
        End If
        ...
        htmlString &= "                 <div style =' vertical-align: middle; width: 240px; padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("Image1").ToString.Trim = "" Then
            htmlString &= "                     &nbsp;"
        Else
            htmlString &= "                     <img alt='' src='Farms/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("Image1").ToString.Trim & "' />"
        End If
        htmlString &= "                 </div>"
        htmlString &= "                 <div style =' vertical-align: middle; width: 240px; padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("Image2").ToString.Trim = "" Then
            htmlString &= "                     &nbsp;"
        Else
            htmlString &= "                     <img alt='' src='Farms/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("Image2").ToString.Trim & "' />"
        End If
        htmlString &= "                 </div>"
        htmlString &= "                 <div style =' vertical-align: middle; width: 240px; padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("Image3").ToString.Trim = "" Then
            htmlString &= "                     &nbsp;"
        Else
            htmlString &= "                     <img alt='' src='Farms/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("Image3").ToString.Trim & "' />"
        End If
        htmlString &= "                 </div>"
