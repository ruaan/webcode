Imports System.Data
Partial Class outfitter_package_view_mobi
...
#Region "Package Information"
    Private Function GetGeninfo() As String
        ...
        htmlString &= " <div id='divInfo' style='background-color: #D7D7D7'>"
        ...
        htmlString &= "                 <div>&nbsp;</div>"
        htmlString &= "                 <div style='display:inline-block; width: 370px; padding: 2px; vertical-align: top;'>"
        htmlString &= "                     <div style= 'width: 100%;'>" & dsInfo.Tables(0).Rows(0).Item("Description").ToString.Trim & "</div>"
        htmlString &= "                     <div>&nbsp;</div>"
        htmlString &= "                     <div style= 'width: 100%; font-weight: 700;'>Total: " & dsInfo.Tables(0).Rows(0).Item("cost").ToString.Trim & "</div>"
        htmlString &= "                     <div>&nbsp;</div>"


        htmlString &= "                     <div style= 'width: 100%; font-weight: 700;'>Included:</div>"
        htmlString &= "                     <div>&nbsp;</div>"
        ...
        If inCount > -1 Then
            For sp1 = 0 To inCount
                ...
                htmlString &= "                             <div style='width: 100px;'>" & dsIncluded.Tables(0).Rows(sp1).Item("Description").ToString.Trim & "</div>"
                htmlString &= "                         </div>"
                htmlString &= "                     </div>"
            Next
        End If
        ...
        htmlString &= "                 <div>&nbsp;</div>"
        htmlString &= "                     <div style= 'width: 100%; font-weight: 700; '>Excluded:</div>"
        htmlString &= "                     <div>&nbsp;</div>"
        htmlString &= "                     <div style= 'width: 100%;'>"
        ...
        If exCount > -1 Then
            For sp2 = 0 To exCount
                htmlString &= "                     <div>"
                htmlString &= "                         <div style='display:inline-block; padding: 2px;'>"
                htmlString &= "                             <div style='width: 100px;'>" & exIncluded.Tables(0).Rows(sp2).Item("Description").ToString.Trim & "</div>"
                htmlString &= "                         </div>"
                htmlString &= "                     </div>"
            Next
        End If
        htmlString &= "                     </div>"
        htmlString &= "                 </div>"
        htmlString &= "                 <div style ='display: inline-block; horizontal-align: right; vertical-align: middle; width: 400px; padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("LargeImage").ToString.Trim <> "" Then
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("LargeImage").ToString.Trim & "' />"
        Else
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/TemplateBig.jpg' />"
        End If
        htmlString &= "                 </div>"
        htmlString &= "                 <div>&nbsp;</div>"
        ...
        If dsInfo.Tables(0).Rows(0).Item("Image1").ToString.Trim = "" Then
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/Template.jpg' />"
        Else
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("Image1").ToString.Trim & "' />"
        End If
        htmlString &= "                 </div>"
        htmlString &= "                 <div style ='display: inline-block; vertical-align: middle; width: 240px; padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("Image2").ToString.Trim = "" Then
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/Template.jpg' />"
        Else
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("Image2").ToString.Trim & "' />"
        End If
        htmlString &= "                 </div>"
        htmlString &= "                 <div style ='display: inline-block; vertical-align: middle; width: 240px; padding: 2px;'>"
        If dsInfo.Tables(0).Rows(0).Item("Image3").ToString.Trim = "" Then
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/Template.jpg' />"
        Else
            htmlString &= "                     <img alt='' src='Outfitters/Images/Packages/" & dsInfo.Tables(0).Rows(0).Item("Image3").ToString.Trim & "' />"
        End If
        htmlString &= "                 </div>"
    ...
    Private Function GetinitialData(ByVal packageId As String) As DataSet
        ...
        str &= " SELECT Package, Description, cost, LargeImage, Image1, Image2, Image3 FROM  tbl_Outfitter_Packages WHERE (packageId = @packageId) "
