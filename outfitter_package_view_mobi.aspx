<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageMobi.master" AutoEventWireup="false" CodeFile="outfitter_package_view_mobi.aspx.vb" Inherits="outfitter_package_view_mobi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="mainPageWrapper">
        <div id="mainBlock" class="div_MainBlock">
            <div class="div_details">
                <div style="border: 1px solid #333333; padding: 10px 10px 12px 10px; background-color: #E2E2E2; display: inline-block; width: 780px">
    ...
    <div>&nbsp;<asp:Button ID="btnTabClick" runat="server" BackColor="Transparent" BorderStyle="None" /></div>
