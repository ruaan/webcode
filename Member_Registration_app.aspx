<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Member_Registration_app.aspx.vb" Inherits="Member_Registration_app" %>
                ...
                <div valign="top" style="clip: rect(0px, auto, auto, auto);">
                    <div id="pnlPersonalDetails" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;">
                        ...
                        <div style="text-align: right">
                            &nbsp;<asp:Button ID="btnSavePersonal" runat="server" Text="Save" CssClass="nextPrevButton" Visible="False" />&nbsp;<asp:Button ID="btnPerNext" runat="server" Text="Register" CssClass="lineButton" />
                        </div>
                        <div style="text-align: right">
                            <asp:Label ID="lblPreSubmit" runat="server" Text=""></asp:Label>
                        </div>
                    </div>
                    ...
                    <div id="pnlMembershipFee" runat="server" class="divMainContainer" style="border-width: thin; border-color: #FFFF00; padding: 7px 5px 5px 5px; border-bottom-style: solid; border-left-style: solid;" visible="False">
                        ...
                        <div style="align-items: center">
                            ...
                            <div class="divFormMng">
                                <div>
                                    <asp:Button ID="btnPayNow" runat="server" CssClass="button" Text="Pay Now" Visible="False" /></div>
                                <div>&nbsp;</div>
                            </div>
                            <div class="divFormMng">
                                <div>&nbsp;</div>
                            ...
                            <div class="divFormMng">
                                <div>
                                    <asp:Button ID="btnPayLater" runat="server" CssClass="button" Text="Pay Later" Visible="False" />
